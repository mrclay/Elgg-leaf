...
class Database extends DbDatabase {
	 ...
	 *
	 * @param array $spec Array with keys:
	 *     sql       : (string) required SQL
	 *     params    : (array) optional params
	 *     results   : (stdClass[]) result rows (required for selects)
	 *     row_count : (int) required for update/delete queries
	 *     insert_id : (int) required for insert queries
	 *     times     : (int) how many times to match this spec (0 = unlimited)
	 *
