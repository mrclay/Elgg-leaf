 ...
 * @access private
 */
function _elgg_setup_page_menu_toggles($hook, $type, $return, $params) {
	foreach ($return as $section => $menu_items) {
...
function _elgg_nav_init() {
	...
	elgg_register_plugin_hook_handler('prepare', 'menu:page', '_elgg_setup_page_menu_toggles', 999);
