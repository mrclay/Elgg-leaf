...
class ehough_stash_Item implements ehough_stash_ItemInterface
{
    ...
    /**
     * This constructor is an internal function used by the ehough_stash_Pool object when
    ...
    /**
     * Returns the key as a string. This is particularly useful when the ehough_stash_Item is
     * returned as a group of ehough_stash_Items in an Iterator.
     *
    ...
    /**
     * Clears the current ehough_stash_Item. If hierarchical or "stackable" caching is being
     * used this function will also remove children ehough_stash_Items.
     *
     * @return bool
     */
    ...
    /**
     * Enables stampede protection by marking this specific instance of the ehough_stash_Item
    ...
    /**
     * This function is used by the ehough_stash_Pool object while creating this object. It
