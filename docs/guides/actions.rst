...
.. code-block:: php
	...
	echo elgg_view('output/url', [
		...
		'href' => "action/entity/delete?" . http_build_query([
			'guid' => $guid,
...
.. code-block:: php
	...
	echo elgg_view('input/text', ['name' => 'example']);
...
.. code-block:: php
	...
	$shares = elgg_extract('shares', $vars, []);
...
.. code-block:: php
	...
	$url = elgg_http_add_url_query_elements(elgg_normalize_url('confirm'), [
		'user_guid' => $user_guid,
	]);
